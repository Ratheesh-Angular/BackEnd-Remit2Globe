...
exports.RELATIONSHIP_OPTIONS = exports.TRANSFER_PURPOSE_OPTIONS = exports.SOURCE_OF_INCOME_OPTIONS = exports.SANDBOX_DEV_FEE_FIXED = exports.SANDBOX_DEV_FEE_PERCENT = exports.SANDBOX_FX_FALLBACK = exports.COUNTRY_META = exports.AFRICAN_SENDER_MOBILE_PAYIN_ISO2 = void 0;
exports.resolveSandboxFallbackRate = resolveSandboxFallbackRate;
/** ISO 3166-1 alpha-2: African countries where we offer USD as alternate pay currency + mobile pay-in. */
exports.AFRICAN_SENDER_MOBILE_PAYIN_ISO2 = new Set([
    "KE",
    "TZ",
    "UG",
    "RW",
 ...
 */
function resolveSandboxFallbackRate(fromCurrency, toCurrency) {
    const from = fromCurrency.toUpperCase();
    const to = toCurrency.toUpperCase();
    if (from === to)
        return 1;
    const directKey = `${from}_${to}`;
    const direct = exports.SANDBOX_FX_FALLBACK[directKey];
    if (direct != null)
        return direct;
    const usdFromKey = `USD_${from}`;
    const usdToKey = `USD_${to}`;
    const usdFrom = from === "USD" ? 1 : exports.SANDBOX_FX_FALLBACK[usdFromKey];
    const usdTo = to === "USD" ? 1 : exports.SANDBOX_FX_FALLBACK[usdToKey];
...
exports.SOURCE_OF_INCOME_OPTIONS = [
...
exports.TRANSFER_PURPOSE_OPTIONS = [
